...
class OpticalAidService(BaseService[OpticalAid]):
    ...
    def __init__(self, optical_aid_repository: OpticalAidRepository):
        super().__init__(
            ...
            MutationEvents(
                added=NightGuideEvent.EQUIPMENT_OPTICAL_AID_ADDED,
                updated=NightGuideEvent.EQUIPMENT_OPTICAL_AID_UPDATED,
                deleted=NightGuideEvent.EQUIPMENT_OPTICAL_AID_DELETED
            )
        )
