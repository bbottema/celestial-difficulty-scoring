...
class NightGuideEvent(metaclass=MetaNightGuideEvent):
    ...
    TARGET_LIST_CREATED = "target_list_created"
    TARGET_LIST_UPDATED = "target_list_updated"
    TARGET_LIST_DELETED = "target_list_deleted"
    TARGET_LIST_ITEM_ADDED = "target_list_item_added"
    TARGET_LIST_ITEM_REMOVED = "target_list_item_removed"
    TARGET_LIST_ITEM_UPDATED = "target_list_item_updated"
